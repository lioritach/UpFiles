                ...
                <div className="app-login-form-inner">
                    <button onClick={() => {
                            ...
                            if(this.props.onClose){
                                this.props.onClose(true); //implement the close button
                            }
                    ...
                    <form onSubmit={this._onSubmit}>
                        ...
                        <div className={classNames('app-form-item', {'error': _.get(error, 'email')})}>
                            ...
                            <input value={user.email} onChange={this._onTextFieldChange} placeholder="Your Email" id="email-id" type="email" name="email" />
